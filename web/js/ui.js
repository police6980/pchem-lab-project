...
function createAnalysisPanel({
    ...
    const QUESTION_FOCUS = {
        ...
        3: "Q3는 학생의 실제 측정 데이터에서 흥미로운 패턴·이상값·추가 탐구 가능성을 발견해 구체적인 탐구 질문 1개를 생성. 질문은 학생 데이터의 실제 숫자를 인용할 것. 질문 생성 후 학생 답변을 기다리고, 답변에 대해 일반 탐구 튜터 방식으로 대화.",
        4: "Q4는 다음 실험 설계. 학생이 제안한 조건의 과학적 의미를 확장. 샤를 법칙, 게이뤼삭 법칙, 이상기체 법칙 등 관련 개념 자연스럽게 소개 가능.",
    };
