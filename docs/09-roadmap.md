...
**마지막 업데이트**: 2026-04-22
**기준 상태**: Phase 1 MVP 완료, Phase 2-A/2-B 완료 (v0.4-boyle-complete), **Phase 3 진행 중** (소프트웨어 완료, 하드웨어·펌웨어 대기), **Phase 4.5 심화 탐구 모드 완료** (`feature/particle-controls` 브랜치, 병합 대기)
...
- [병행] **반응형 레이아웃** — 별도 브랜치 진행 중 (현 심화 탭은 데스크탑 ≥1872 px 최적)
...
- [ ] `runPVAccuracyTest` 를 500 kPa 확장 범위에 맞춰 갱신
...
### 4.5-5. 알려진 제약
- 데스크탑 ≥ 1872 px 가정 (심화 탭의 메인+추적 캔버스 1000+24+400 px + 사이드바 380 px)
- 반응형 레이아웃은 별도 브랜치에서 진행 예정
